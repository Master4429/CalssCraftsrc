package com.hassam.classcraft.gui;
...
import com.hassam.classcraft.util.ClientUtil;
...
public class GuiCustomMainMenu extends GuiScreen
{
    ...
    private static final ResourceLocation LOGO_TEXTURE = new ResourceLocation("cc:textures/gui/logo.png");
    ...
    public void initGui()
    {
        ...
        modUpdateNotification = ClientUtil.initMenu(this, modButton);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.splashText = ClientUtil.renderMainMenu(this, this.fontRenderer, this.width, this.height, this.splashText);
        ...
        brandings.add("ClassCraft -> " + Reference.VERSION);
